    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                # Write results
                #---ALEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX [UPDATE]
                det_len = len(det)
                dic_list = [None]*det_len
                ...
                if save_txt:
                    with open(txt_path.lower() + '.json', 'w', encoding='utf-8') as json_file:
                        json.dump({ Path(txt_path).name : dic_list }, json_file, ensure_ascii=False, indent=4)
                #---ALEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX [UPDATE]
